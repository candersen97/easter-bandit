...
const STEPS = [
  ...
  },
  {
    ...
    result: 'Find the object with a removable top in the living room → coffee table.',
  },
  {
    step: 3,
    title: 'Coffee Table',
    node: 'FIREWALL 03 // CLASSIFIED DOCUMENT',
    location: 'Physical card hidden under removable coffee table top',
  ...
  },
  {
    ...
    what: 'Find the Milwaukee blower in the garage. Take it to the deck. Blow away debris to reveal the next clue.',
    result: 'Reveals card hidden under leaves on deck.',
  },
  {
    step: 6,
    title: 'Deck',
    node: 'FIREWALL 06 // SCATTERED INTEL',
    location: 'Physical card hidden under leaves/debris on deck (laminated)',
    what: 'Read clue pointing to something soft, aromatic, smells like cedar/pine.',
